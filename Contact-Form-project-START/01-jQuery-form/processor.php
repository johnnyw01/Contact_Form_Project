...
<?php 
	//In this PHP file, you will see that it takes data from the form, makes sure the fields aren’t empty, and that the email address is actually an email address, then simply echos back the data.
